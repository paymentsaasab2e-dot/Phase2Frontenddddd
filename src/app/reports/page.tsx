...
const PipelineFunnel = () => (
  <div className="space-y-6">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
      <KPICard label="Total in Pipeline" value="1,000" trend="+10%" icon={Users} color="bg-blue-600" />
      <KPICard label="Shortlisted" value="600" trend="+6%" icon={Briefcase} color="bg-purple-600" />
      <KPICard label="Interviewing" value="200" trend="+3%" icon={Calendar} color="bg-orange-600" />
      <KPICard label="Offers / Joins" value="65" trend="+2%" icon={CheckCircle2} color="bg-green-600" />
    </div>
...
const JobsClients = () => (
  <div className="space-y-6">
    {/* Summary tiles */}
    <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
      <KPICard label="Active Jobs" value="124" trend="+9%" icon={Briefcase} color="bg-blue-600" />
      <KPICard label="Active Clients" value="42" trend="+4%" icon={Users} color="bg-indigo-600" />
      <KPICard label="Urgent Roles" value="18" trend="+1.5%" icon={Target} color="bg-red-600" />
      <KPICard label="Avg. Time to Fill" value="32 days" trend="-3%" icon={Clock} color="bg-green-600" />
    </div>
...
const CandidateReports = () => (
  <div className="space-y-6">
    {/* Summary tiles */}
    <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
      <KPICard label="Total Candidates" value="5,420" trend="+7%" icon={Users} color="bg-blue-600" />
      <KPICard label="New This Month" value="820" trend="+12%" icon={UserPlus} color="bg-purple-600" />
      <KPICard label="Hotlist" value="145" trend="+5%" icon={Target} color="bg-orange-600" />
      <KPICard label="Average Experience" value="4.2 yrs" trend="+0.3" icon={BarChart3} color="bg-green-600" />
    </div>
...
const InterviewReports = () => (
  <div className="space-y-6">
    {/* Summary tiles */}
    <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
      <KPICard label="Interviews Scheduled" value="128" trend="+11%" icon={Calendar} color="bg-blue-600" />
      <KPICard label="Completed" value="96" trend="+9%" icon={CheckCircle2} color="bg-green-600" />
      <KPICard label="No‑Shows" value="6" trend="-2%" icon={Clock} color="bg-red-600" />
      <KPICard label="Avg. Interview Rounds" value="2.3" trend="+" icon={BarChart3} color="bg-indigo-600" />
    </div>
...
function TeamPerformanceView() {
  return (
    <div className="space-y-6">
      {/* Summary tiles */}
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
        <KPICard label="Active Recruiters" value="18" trend="+2" icon={Users} color="bg-blue-600" />
        <KPICard label="Avg. Placements / Recruiter" value="3.1" trend="+0.4" icon={Target} color="bg-green-600" />
        <KPICard label="Top Performer Placements" value="8" trend="+1" icon={TrendingUp} color="bg-purple-600" />
        <KPICard label="Tasks Completed" value="1,240" trend="+6%" icon={CheckCircle2} color="bg-indigo-600" />
      </div>
...
function CustomReports() {
  return (
    <div className="space-y-6">
      {/* Summary tiles */}
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
        <KPICard label="Saved Templates" value="12" trend="+3" icon={FileText} color="bg-blue-600" />
        <KPICard label="Reports Generated" value="84" trend="+18%" icon={Download} color="bg-green-600" />
        <KPICard label="Scheduled Reports" value="9" trend="+2" icon={Clock} color="bg-purple-600" />
        <KPICard label="Last Generated" value="Today" trend="" icon={Calendar} color="bg-indigo-600" />
      </div>
        ...
        <Card className="lg:col-span-2" title="Report Preview">
          <div className="flex flex-col items-center justify-center h-full min-h-[300px] text-center">
            ...
            <p className="text-sm text-slate-500 mt-1 max-w-xs">
              Select a data source and columns on the left to generate a preview of your custom report.
            </p>
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-slate-900 font-sans">
      ...
      <div className="p-8">
        ...
        {/* Filters section moved below page header */}
        <div className="bg-white border border-slate-200 rounded-xl px-6 py-4 shadow-sm mb-4">
        ...
        {/* Tabs section moved below page header and filters */}
        <div className="bg-white border border-slate-200 rounded-xl px-2 flex overflow-x-auto no-scrollbar shadow-sm mb-8">
          {tabs.map((tab) => (
            <button
              key={tab}
